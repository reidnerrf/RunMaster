...
export default function IconButton({ onPress, children, style, color = '#FF6B00' }: { onPress: () => void; children: React.ReactNode; style?: ViewStyle; color?: string }) {
  ...
  return (
    <Animated.View style={{ transform: [{ scale }] }}>
      <Pressable onPressIn={onIn} onPressOut={onOut} onPress={onPress} style={[styles.btn, { backgroundColor: color }, style]}> 
        {children}
      </Pressable>
    </Animated.View>
  );
